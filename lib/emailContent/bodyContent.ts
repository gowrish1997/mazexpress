 function user_registerBodyContet() {
    return ["We’re excited to welcome you to Untitled and we’re even more excited about what we’ve got planned. You’re already on your way get your products delivered.","Untitled and we’re even more excited about what we’ve got planned. You’re already on your way get your products delivered."]
}
 function admin_registerBodyContent() {
    return ["New user has registered on Maz Express. We are pleased to welcome this user to our platform and hope to provide them with the best services possible.","The user's information is as follows:"]
}

 function user_forgotPasswordContent() {
    return ["We have received your request for a password reset for your Maz Express account. We understand how important it is for you to access your account, and we are here to help you with that.","To reset your password Click reset password"]
}
 function user_passwordChangedContent() {
    return ["This is to inform you that your Maz Express account password has been successfully changed. Please note that if you did not initiate this change or suspect any unauthorized activity on your account, please contact us immediately."]
...
function user_orderDelivered(order_id:string) {
    return [`Thank you for ordering with us. We are happy to inform you that your order No. ${order_id} has been delivered to you successfully. If you have any queries or concerns regarding your order, please feel free to contact us. We are always here to assist you.`];
}

export {
    user_registerBodyContet,admin_registerBodyContent,user_orderPlaced,admin_orderPlaced,user_orderDispatched,user_orderDelivered,user_forgotPasswordContent,user_passwordChangedContent
}
