...
const ShipmentCalculator = React.forwardRef<HTMLDivElement>((props, ref) => {
    ...
    return (
        <div className="flex-type3 bg-[#F5F5F5] rounded-[8px] mt-[120px] p-[70px]" ref={ref}>
            <div className="flex-1 space-y-[15px] ">
                <h1 className="text-[24px] text-[#121212] font-[700] leading-[50px] ">Shipment Cost Calculator</h1>
                ...
                <p className=" w-[85%] text-[16px] text-[#525D72] font-[500] leading-[25.5px] ">
                    Drop off and pick up packages from a location that’s open when you need it. Drop off and pick up packages from a location that’s open when you need it. Drop off
                    and pick up packages from a location that’s open when you need it. Drop off and pick up packages from a location that’s open when you need it
                </p>
            </div>
