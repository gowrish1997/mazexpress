...
const Footer = React.forwardRef<HTMLDivElement>((props, ref) => {
    ...
    return (
        <div className="h-[396px] bg-[#2B2B2B] mt-[40px] md:mt-[100px] px-[40px] xmd:px-[120px] py-[30px] md:py-[70px] space-y-[30px]" ref={ref}>
            ...
            <div className="text-[#BFB8AF] text-[14px] leading-[20.4px] font-[400]">{t("landingPage.footer.Copyright")}</div>
        </div>
    );
});
