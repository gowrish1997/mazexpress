...
const ShipmentCostCalculator = React.forwardRef<HTMLDivElement>(
  (props, ref) => {
    ...
    return (
      <div
        className="flex-type5 min-[950px]:flex-type3 p-[20px] md:p-[70px] flex-wrap space-y-[40px] bg-[#F5F5F5] rounded-[8px] mt-[40px] md:mt-[120px] "
        ref={ref}
      >
        <div className="flex-1 space-y-[15px] ">
          ...
          >
            {t("landingPage.shipmentCostCalculator.Discription")}
          </p>
        </div>
        <form
