    ...
    >
      ...
      >
        ...
        <div className="w-[100%] absolute top-[35%]  left-0 flex flex-col justify-start items-center gap-y-[20px] ">
          <h1 className="text-[30px] add_sm:text-[40px] xmd:text-[50px] leading-[30px] add_sm:leading-[45px] xmd:leading-[62px] text-[#FFFFFF] font-[700] font-manrope ">
            {t("landingPage.service.Title")}
          </h1>
          <p className="text-[14px] add_sm:text-[18px] xmd:text-[22px] leading-[22px] add_sm:leading-[28px] xmd:leading-[33px] text-[#FFFFFF] font-[400] w-[80%] add_sm:w-[70%] xmd:w-[45%] min-[1650px]:w-[38%] text-center font-inter ">
            {t("landingPage.service.Description")}
          </p>
        </div>
      </div>
      <div className="w-[95%] sm:w-[80%] table_md:w-[57%] min-[1600px]:w-[40%] flex flex-col justify-start items-center  gap-y-[20px] mt-[50px]">
        ...
        <p className="text-[14px] add_sm:text-[18px] xmd:text-[18px] leading-[20px] add_sm:leading-[24px] xmd:leading-[28px] text-[#1B1F29] font-[400]  text-center font-inter ">
        ...
        {content.map((data, index) => {
          return (
            <div
              ...
              } justify-center items-start add_sm:items-center gap-x-[15px] table_md:gap-x-[25px] xmd:gap-x-[40px]  gap-y-[10px] `}
              key={index}
            >
              ...
              <div
                className={`flex-1  flex flex-col justify-start min-[1400px]:gap-y-[5px] min-[1650px]:gap-y-[10px] ${
                  index % 2 == 0 ? "items-start" : "items-end"
                } `}
              >
                <div
                  className={`hidden add_sm:w-[100%] add_sm:flex flex-col justify-start min-[1400px]:gap-y-[5px]  min-[1650px]:gap-y-[10px]   ${
                    index % 2 == 0 ? "items-start" : "items-end"
                  }`}
                >
                  <div
