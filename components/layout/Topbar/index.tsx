  ...
  return (
    <div className="flex w-full min-h-[60px] pb-[30px] items-center justify-between">
      <div className="w-4/5 h-[46px] border-[0.5px] boder-[#8794AD] rounded-[6px] p-[5px] pl-[15px] relative">
        <input
          className="w-full h-full bg-transparent focus:outline-none searchbar"
          id="searchbar"
          type="text"
      ...
      <div className="flex min-h-[65px] items-center justify-end">
        <span className="relative top-0.5 mr-5">
          {notifications && notifications.length > 0 && (
            <span className="rounded-full block top-0 h-[7px] w-[7px] -right-[1px] bg-orange-600 absolute"></span>
          )}
