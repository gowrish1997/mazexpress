...
import { faAngleDown, faUserCircle, faBell } from "@fortawesome/free-solid-svg-icons";
const Topbar = () => {
    return (
        <div className="flex w-full min-h-[60px] pb-[30px] items-center justify-between">
            ...
            <div className="flex min-h-[65px] items-center justify-end">
                ...
                <Image src={"/profile.png"} className="rounded-full" width={31} height={30} alt="profileImage" />
                <p className="font-[500] text-[#525D72] text-[14px] leading-[19px] mx-2">Lincoln Bergson</p>
