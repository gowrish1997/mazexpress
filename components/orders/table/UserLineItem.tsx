...
const UserLineItem = (props: IProp) => {
    ...
    return (
        <tr className="h-min text-[16px] text-[#000000] font-[400] leading-[22.4px] relative" style={{ transform: "scale(1)" }}>
            ...
            <td className={`td1`}>{`${props.row.first_name_users} ${props.row.last_name_users}`}</td>
            ...
            <td className={`flex flex-row justify-start items-center h-full `}>{props.row.gender_users}</td>
            <td
                className=""
