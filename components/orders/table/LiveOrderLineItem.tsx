  ...
  return (
    <>
      ...
      >
        {(props.type == "pending" ||
          ...
          <td className={`td0`}>
            <input
              ...
              onChange={(e) => props.onSelect(props.row, "selectSingleOrder")}
        ...
        <td className={`flex flex-row justify-start items-center capitalize`}>
          <div className="relative h-[30px] w-[30px] rounded-full overflow-hidden ">
            <Image
              src={
                props.row.user?.avatar_url || "/user-images/default_user.png"
              }
              fill
      ...
      {showOrderDetailModal && (
        <OrderDetailModal close={toggleOrderDetailModal} row={props.row} />
      )}
