        ...
        <form className=" box-border flex-type6  bg-[#ffffff] rounded-[8px] py-[30px] px-[25px] w-[600px]  gap-y-[15px]">
          ...
          <div className="flex flex-row justify-start items-start w-full ">
            ...
            <div className="transition duration-300 flex flex-col items-start border-[0.4px] border-[#BBC2CF] hover:bg-[#EDF5F9] rounded-[4px] p-[5px] h-full w-full">
              ...
              <Card content="Reference id" value={props.row.reference_id} />
              <Card content="Store link" value={props.row.store_link} />
            </div>
          </div>
          <div className="flex flex-row justify-start items-start w-full ">
            <p className="w-[30%] text-[15px] text-[#2B2B2B] font-[700] leading-[25px] mb-[10px]">
            ...
            <div className="transition duration-300 flex flex-col items-start border-[0.4px] border-[#BBC2CF] hover:bg-[#EDF5F9] rounded-[4px] p-[5px] h-full w-full">
              ...
              />
              <Card content="Email" value={props.row.user.email} />
              <Card content="Phone" value={props.row.address.phone!} />
              <Card
                content="Gender"
          ...
          <div className="flex flex-row justify-start items-start w-full ">
            ...
            <div className="transition duration-300 flex flex-col items-start border-[0.4px] border-[#BBC2CF] hover:bg-[#EDF5F9] rounded-[4px] p-[5px]  h-full w-full ">
              ...
              />
              <Card content="City" value={props.row.address.city} />
              <Card content="Country" value={props.row.address.country} />
            </div>
          </div>
