...
const WarehouseCard = (props: IProp) => {
    ...
    return (
        <>
            <div className="box-border w-[350px] h-[220px] sm:h-[220px] md:min-w-[49%] md:max-w-[49%] xmd:min-w-[32.5%] xmd:max-w-[32.5%] border-[0.4px] border-[#BBC2CF] hover:bg-[#EDF5F9] rounded-[4px] p-[25px]  ">
