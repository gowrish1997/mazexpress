...
const ConfigCard = (props: IProp) => {
  ...
  const deleteNotificationConfig = async () => {
    ...
    const deleteResult: APIResponse<NotificationConfig> = await fetchJson(`/api/notification-settings/${props.data.id}`, {
      method: "DELETE",
  ...
  return (
    <div
      className="min-w-[32%] min-h-[180px] rounded-[4px] p-[25px] flex flex-col justify-between"
      style={{
