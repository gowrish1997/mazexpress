...
const WarehouseTracking = (props) => {
    // const [firstWarehouse, setFirstWareHouse] = useState(false);
    // const [secondtWarehoue, setSecondWareHouse] = useState(false);
    // const [thirdWarehouse, setThirdWarehouse] = useState(false);
    const [packageStatus,setPackageStatus]=useState(props.status)
