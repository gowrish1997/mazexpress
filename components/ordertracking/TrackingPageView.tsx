      ...
      <div className="flex-type2 justify-start w-[100%] gap-x-[50px] px-[20px] ">
        ...
        <div className="flex-type6 text-[#525D72] font-[500] leading-[21px] text-[14px] ">
          <div className="flex-type6 gap-y-[5px] mt-[20px]  ">
            <p
              className={`${
                props.packageStatus >= 0 ? "text-[#2B2B2B] font-[600] " : ""
              }`}
            >
              {t("trackingView.view.packageStatus.stageFirst.Title")}
            </p>
            <button
          ...
          <div className="flex-type6 gap-y-[5px] mt-[55px] ">
            <p
              className={`${
                props.packageStatus >= 1 ? "text-[#2B2B2B] font-[600] " : ""
              }`}
            >
              {t("trackingView.view.packageStatus.stageSecond.Title")}
            </p>
            <button
              className={`text-[10px] leading-[15px] bg-[#EDF5F9] rounded-[15px] p-[7px] px-[9px] ${
          ...
          <div className="flex-type6 gap-y-[5px] mt-[25px] ">
            <p
              className={`${
                props.packageStatus >= 4 ? "text-[#2B2B2B] font-[600] " : ""
              }`}
            >
              {t("trackingView.view.packageStatus.stageThird.Title")}
            </p>
            <button
              className={`text-[10px] leading-[15px] bg-[#EDF5F9] rounded-[15px] p-[7px] px-[9px] ${
          ...
          <div className="flex-type6 gap-y-[5px] mt-[110px] ">
            <p
              className={`${
                props.packageStatus >= 5 ? "text-[#2B2B2B] font-[600] " : ""
              }`}
            >
              {t("trackingView.view.packageStatus.stageFour.Title")}
            </p>
            <button
              className={`text-[10px] leading-[15px] bg-[#EDF5F9] rounded-[15px] p-[7px] px-[9px] ${
                props.packageStatus == 5 ? "text-[#FFBA00] bg-[#FFF8E3]" : ""
              }`}
            >
