...
const Frame = (props: IFrameProps) => {
  ...
  return (
    ...
    <div className="flex bg-[#FFFFFF] relative min-h-screen w-full">
      ...
      {!(router.pathname == "/") ? (
        <div className={`box-border flex-1   ${locale == "en" ?"ml-[80px] sm:ml-[180px] md:ml-[250px] lg:ml-[400px] xlg:ml-[500px]":"mr-[80px] sm:mr-[180px] md:mr-[250px] lg:mr-[400px] xlg:mr-[500px]"} p-5 pt-0 flex flex-col relative `}>
          <Topbar />
          {props.children}
        </div>
      ) : (
