...
const Input = (props: IProp) => {
    return (
        <div className={"w-full flex-type6 space-y-[5px] " + " " + props.parentClassName}>
            ...
            <div className={"flex-type1 w-full border-[1px] border-[#BBC2CF] rounded-[4px] box-border p-[5px] " + " " + props.inputClassName}>
                <input id={props.name} type={props.type}  className="w-full h-full focus:outline-none" onChange={(e)=>props.onChange?.(e)} />
            </div>
