                        ...
                        <div className="flex-type2 justify-center w-[50%] space-x-[50px] ">
                            ...
                            <div className="flex-type6 text-[#525D72] font-[500] leading-[21px] text-[14px] ">
                                <div className="flex-type6 gap-y-[5px] mt-[20px]  ">
                                    <p className={`${packageInSourceWebSite ? "text-[#2B2B2B] font-[600] " : ""}`}>Source website</p>
                                    <button
                                        className={`text-[10px] leading-[15px] bg-[#EDF5F9] rounded-[15px] p-[7px] px-[9px] ${
                                            packageInSourceWebSite ? "text-[#664de5] bg-[#A7C7E7] " : ""
                                        }`}
                                    >
                                ...
                                <div className="flex-type6 gap-y-[5px] mt-[55px] ">
                                    <p className={`${packageInWarehouse ? "text-[#2B2B2B] font-[600] " : ""}`}>Warehouse</p>
                                    <button
                                        className={`text-[10px] leading-[15px] bg-[#EDF5F9] rounded-[15px] p-[7px] px-[9px] ${
                                ...
                                <div className="flex-type6 gap-y-[5px] mt-[140px] ">
                                    <p className={`${packageOutForDelivery ? "text-[#2B2B2B] font-[600] " : ""}`}>Out for delivery</p>
                                    <button
                                        className={`text-[10px] leading-[15px] bg-[#EDF5F9] rounded-[15px] p-[7px] px-[9px] ${
                                            packageOutForDelivery ? "text-[#FFBA00] bg-[#FFF8E3] " : ""
                                        }`}
                                    >
                                ...
                                <div className="flex-type6 gap-y-[5px] mt-[110px] ">
                                    <p className={`${packageDelivered ? "text-[#2B2B2B] font-[600] " : ""}`}>Delivered</p>
                                    <button
                                        className={`text-[10px] leading-[15px] bg-[#EDF5F9] rounded-[15px] p-[7px] px-[9px] ${
