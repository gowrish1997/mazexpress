...
const Settings = () => {
  ...
  > = async (data) => {
    try {
      ...
      const updateRes = await fetchJson(`/api/users/${session?.user?.email}`, {
        method: "PUT",
          ...
          >
                  ...
                  <Controller
                    ...
                    render={({ field: { onChange, value } }) => (
                      <ReactHookFormInput
                        ...
                        type={passwordType}
                        value={value}
                        error={errors.password?.message && fieldErrors[2]}
                        icon={{
                          isEnabled: true,
                          src:
                            passwordType === "string"
                ...
                <Controller
                  ...
                  render={({ field: { onChange, value } }) => (
                    <ReactHookFormInput
                      ...
                      value={value}
                      onChange={onChange}
                      error={errors.newPassword?.message && fieldErrors[4]}
                      icon={{
                        isEnabled: true,
                        src:
            ...
            <div className="flex-type3 w-full mt-[10px] ">
              ...
              <Controller
                ...
                control={control}
                defaultValue={session?.user?.is_notifications_enabled!}
                render={({ field: { onChange, value } }) => (
                  <ReactSwitch
                    onChange={onChange}
