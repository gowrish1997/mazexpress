                        ...
                        <div className="flex flex-row justify-between items-end gap-x-[20px] ">
                            ...
                            <div className="md:hidden  relative ">
                                <div
                                    ...
                                    style={showOptionModal? { backgroundColor: "#35C6F4", color: "#FFFFFF" } : {}}
                                ...
                                >
                                    ...
                                    >
                                        {showOptionModal ? <FontAwesomeIcon icon={faXmark} /> : <FontAwesomeIcon icon={faBars} />}
                                    </div>
                                    {showOptionModal && (
                                        <div
                                            className={`absolute top-[0px] ${locale=='en'?"left-[36px]":"right-[36px]"}  w-[200px] bg-[#ffffff] border-[1px] border-[#EDF5F9] rounded-[6px] z-10 flex flex-col justify-between items-start p-[5px]`}
                                            style={{ boxShadow: "0px 10px 20px rgba(0, 0, 0, 0.1)" }}
                                            // ref={ref}
                                        >
                                            <ul className=" w-full text-[#121212] text-[14px] font-[400] leading-[39px]  ">
                                                <li
                                                    ...
                                                    onClick={() => trackingSectionRef?.current?.scrollIntoView({ behavior: "smooth" })}
                                                >
                                                    {t(section[0])}
                                                </li>
                                                <li
                                                    className="hover:bg-[#EDF5F9] w-full rounded-[4px] "
                                                    onClick={() => shipmentCalculatorSectionRef?.current?.scrollIntoView({ behavior: "smooth" })}
                                                >
                                                    {t(section[1])}
                                                </li>
                                                <li
                                                    className="hover:bg-[#EDF5F9] w-full rounded-[4px] "
                                                    onClick={() => supportSectionRef?.current?.scrollIntoView({ behavior: "smooth" })}
                                                >
                                                    {t(section[2])}
                                                </li>
                                            </ul>
