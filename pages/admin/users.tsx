        ...
        <>
            <div>
                ...
                <div className="flex flex-col justify-between relative flex-1 h-full">
                    ...
                    {filteredUsers && (
                        <>
                            <Table rows={currentUsers} headings={tableHeaders} type="user_base" />
                            <ReactPaginateComponent pageCount={pageCount} offsetHandler={itemOffsetHandler} itemsPerPage={itemsPerPage} item={filteredUsers} />
                        </>
                    )}
                </div>
